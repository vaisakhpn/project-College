...
<form method="POST" style="margin-left: 10%;">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputName" placeholder="Enter Student Name">
    </div>
  </div>
  <div class="form-group row">
    <label for="inputAdmissionNumber" class="col-sm-2 col-form-label">Admission Number:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="admi" placeholder="Enter your admission number">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="inputGuardianName" class="col-sm-2 col-form-label">Relation</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputGuardianName" placeholder="Relation with Student">
    </div>
  </div>
  <div class="form-group row">
    <label for="inputContactNumber" class="col-sm-2 col-form-label">Contact Number:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="ph" placeholder="Enter your contact number">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <div class="col-sm-10 offset-sm-2">
      <button type="submit" name="submitp" class="btn btn-primary">Save</button>
    </div>
  </div>
